#ifndef _GAZOLAND_SRC_MN_GFX_H_
#define _GAZOLAND_SRC_MN_GFX_H_
...
//
//
//extern std::shared_ptr<program> terrain_prog;
//extern std::shared_ptr<program> polygon_fill_prog;
