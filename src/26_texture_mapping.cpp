...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("assets/spirv/vulkan_tutorial_vert.spv");
        auto fragShaderCode = readFile("assets/spirv/vulkan_tutorial_frag.spv");
